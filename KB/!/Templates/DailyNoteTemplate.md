...
- [ ] Отработать по задачам в документообороте [1С ДО](http://corpdoc.zyfra.com/DocMng/ru/)
- [ ] Отработать по уведомлениям в [Confluence/Jira](https://jira.zyfra.com/wiki/#all-updates)
- [ ] Регулярно вечером:
